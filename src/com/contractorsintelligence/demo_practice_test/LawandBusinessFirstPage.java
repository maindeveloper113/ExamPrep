...
public class LawandBusinessFirstPage extends Activity implements
		OnClickListener {
	...
	private static final String TAG_All_Questions = "Examsdetails";
	...
	private class GetData extends AsyncTask<String, Void, Void> {
		private Dialog Dialog = new Dialog(LawandBusinessFirstPage.this);
				...
				for (int i = 0; i < all_questions.length(); i++) {
					...
					JSONObject c = all_questions.getJSONObject(i);
					 ...
					 try {
						...
						passing_score = Math.round(80 * QuestionsList.size() / 100);
					} catch (Exception e) {
						//e.printStackTrace();
					}
				}
	...
	public void SendTestName() {
		...
		try {
			...
			String uri = StaticData.link + "get_test_subtests_details_updated.php";
