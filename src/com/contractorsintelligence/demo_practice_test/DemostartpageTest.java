...
public class DemostartpageTest extends Activity implements OnClickListener {
	...
	public void onClick(View v) {
		...
		case R.id.btn_start:
			try {
				...
				Intent intent = new Intent(DemostartpageTest.this,
						StartLABtest.class);
				Bundle b = new Bundle();
	...
	private class GetData extends AsyncTask<String, Void, Void> {
		private Dialog Dialog = new Dialog(DemostartpageTest.this);
	...
	public void SendTestName() {
		try {
			...
			Log.e("Selected", "Demo TestName" + TestName);
			Log.e("get", "Demo Test Id" + TestId);
			Log.e("data", "sent");
